...
public class SimpleFragment extends Fragment {
    ...
    private static final String CHOICE_ARG_KEY = "radioChoice";
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        this.mRadioButtonChoice = args.getInt(CHOICE_ARG_KEY, NONE);

        if(this.mRadioButtonChoice != NONE) {
    ...
    public static SimpleFragment newInstance(int choice) {
        ...
        args.putInt(CHOICE_ARG_KEY, choice);
